;+
; :Description:
;    Task to test IDL task engine of IDL BYTEARRAY datatype
;    See qa_idltaskengine_datatype_bytearray.task for details
;       
; :Author:
;    GG, March, 2016 - Initial Draft
;-
pro qa_idltaskengine_datatype_bytearray, INPUT=input, $
                                        OUTPUT=output, $
