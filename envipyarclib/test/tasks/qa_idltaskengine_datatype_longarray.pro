;+
; :Description:
;    Task to test IDL task engine of IDL LONGARRAY datatype
;    See qa_idltaskengine_datatype_longarray.task for details
;       
; :Author:
;    GG, March, 2016 - Initial Draft
;-
pro qa_idltaskengine_datatype_longarray, INPUT=input, $
                                        OUTPUT=output, $
