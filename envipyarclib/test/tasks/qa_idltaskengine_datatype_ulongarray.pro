;+
; :Description:
;    Task to test IDL task engine of IDL ULONGARRAY datatype
;    See qa_idltaskengine_datatype_ulongarray.task for details
;       
; :Author:
;    GG, March, 2016 - Initial Draft
;-
pro qa_idltaskengine_datatype_ulongarray, INPUT=input, $
                                        OUTPUT=output, $
