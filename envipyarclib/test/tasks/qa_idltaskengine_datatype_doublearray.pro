;+
; :Description:
;    Task to test IDL task engine of IDL DOUBLEARRAY datatype
;    See qa_idltaskengine_datatype_doublearray.task for details
;       
; :Author:
;    GG, March, 2016 - Initial Draft
;-
pro qa_idltaskengine_datatype_doublearray, INPUT=input, $
                                        OUTPUT=output, $
