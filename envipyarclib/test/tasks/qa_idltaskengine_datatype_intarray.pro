;+
; :Description:
;    Task to test IDL task engine of IDL INTARRAY datatype
;    See qa_idltaskengine_datatype_intarray.task for details
;       
; :Author:
;    MAJ, February, 2015 - Initial Draft
;-
pro qa_idltaskengine_datatype_intarray, INPUT=input, $
                                        OUTPUT=output, $
