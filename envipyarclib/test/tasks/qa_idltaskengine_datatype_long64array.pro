;+
; :Description:
;    Task to test IDL task engine of IDL LONG64ARRAY datatype
;    See qa_idltaskengine_datatype_long64array.task for details
;       
; :Author:
;    GG, March, 2016 - Initial Draft
;-
pro qa_idltaskengine_datatype_long64array, INPUT=input, $
                                        OUTPUT=output, $
